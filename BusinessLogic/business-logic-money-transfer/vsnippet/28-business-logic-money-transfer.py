...
from markupsafe import escape  # Modified by Rezilant AI, 2025-03-23 17:48:37 GMT, Added for secure HTML escaping
...
def index():
    ...
    # Modified by Rezilant AI, 2025-03-23 17:48:37 GMT, Replaced direct HTML construction with secure template variables to prevent XSS
    message_text = ''
    message_type = ''
    ...
    try:
        ...
        if withdrawAmount is not None and withdrawAmount <= user.Balance:
            ...
            message_text = f'You withdraw {user.Currency}: {withdrawAmount}'
            message_type = 'success'
        else:
            message_text = "You don't have that much!"
            message_type = 'error'
    except:
        pass
